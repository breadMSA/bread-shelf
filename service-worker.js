const CACHE_NAME = "bread-shelf-shell-v16";
const DATA_CACHE = "bread-shelf-data-v1";
const SHELL = ["./", "./index.html", "./assets/styles.css?v=20260804-3", "./assets/reader-polish.css?v=20260814-9", "./assets/offline-polish.css?v=2", "./assets/app.js?v=20260814-6", "./assets/offline.js?v=2", "./assets/ux-fixes.js?v=20260730-3", "./assets/author-config.js?v=20260730-2", "./assets/icons/icon-192.png", "./assets/icons/icon-512.png"];
